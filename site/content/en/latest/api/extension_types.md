...
| `logOmitEmpty` | _boolean_ |  false  |  | OmitEmpty defines whether empty logs should be omitted from the final log.<br />This sets Envoy [omit_empty_values](https://www.envoyproxy.io/docs/envoy/latest/api-v3/config/core/v3/substitution_format_string.proto#envoy-v3-api-field-config-core-v3-substitutionformatstring-omit-empty-values). |
